...
def build_qa_user_messages(
    ...
    *,
    ...
    messages.append(_qa_content_body(body))
    return messages
...
def build_qa_chat_messages(
    ...
    *,
    ...
    for part in build_qa_user_messages(content, bundle, segment_label=segment_label):
...
def build_qa_user_prompt(
    ...
    *,
    ...
    return _QA_MESSAGE_JOIN.join(
        build_qa_user_messages(content, bundle, segment_label=segment_label)
    )
